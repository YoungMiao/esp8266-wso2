...
void RibbonGroupPopup::paintEvent(QPaintEvent* event)
{
    ...
    int indent = 0;
    if (RibbonGroupPrivate::_get(m_group)->m_optionButton->isVisible())
...
/*!
\class RibbonMinimizedEvent
\internal
*/
RibbonMinimizedEvent::RibbonMinimizedEvent()
    : QEvent(RibbonMinimizedEvent::getEventType())
{
}

QEvent::Type RibbonMinimizedEvent::getEventType()
{
